...
if CONFIG.DB_ENGINE.lower() == 'mysql':
    DB_OPTIONS['init_command'] = "SET foreign_key_checks=0,sql_mode=STRICT_TRANS_TABLES;"
...
# 巡检数据存档
ROUTING_INSPECTION_DATA_PATH = CONFIG.ROUTING_INSPECTION_DATA_PATH or "/home/xunjian_data/"
# 巡检数据归档
ROUTING_INSPECTION_FILE_SAVE = CONFIG.ROUTING_INSPECTION_FILE_SAVE or "/xunjian_data/"
...
# 对账文件管理系统地址
RDM_URL = CONFIG.RDM_URL or "localhost:5050"

# 是执行否定时任务
PERIOD_TASK = CONFIG.PERIOD_TASK or "off"

# 风控系统配置
RCS_IP = CONFIG.RCS_IP or '10.10.3.46'
COLLECT_SCRIPT_PATH = CONFIG.COLLECT_SCRIPT_PATH or '/opt/CronScript/RA.py'

# 切换发布任务执行方式
DEPLOY_CELERY = CONFIG.DEPLOY_CELERY or "on"
