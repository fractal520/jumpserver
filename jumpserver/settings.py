...
# 巡检数据存档
ROUTING_INSPECTION_DATA_PATH = CONFIG.ROUTING_INSPECTION_DATA_PATH
# 巡检数据归档
ROUTING_INSPECTION_FILE_SAVE = CONFIG.ROUTING_INSPECTION_FILE_SAVE
...
# 切换发布任务执行方式
DEPLOY_CELERY = CONFIG.DEPLOY_CELERY or True
